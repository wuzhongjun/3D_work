function [ out_image] = five_points_to_frontal_v2( in_image_name, five_xy )
...
%         plywrite(fullfile(outDir4,tmptmp_str{i}), tmp_ge, repmat(new_gem_tex,3,1), vertex_dtdt); 
        ...
        cur_img_dir = ['D:\learning_opengl\BaselFace\02_profile_frontal_m\' out_image_name(1:end-4) '_' num2str(cnt) '_frontal.bmp'];
...
%         if abs(P_angle_y{cnt}) > 10 
        ...
        resize_img_dir = ['D:\learning_opengl\BaselFace\02_profile_frontal_resize_m\' out_image_name(1:end-4) '_' num2str(cnt) '_resize.bmp'];
