...
i = find( id == 4000 & kind(1,:) == 22 & kind(2,:) == 05 );   % Find individual 4000 shot by camera 5 (22) and lighted with flash 18 (05)
alpha = reshape(feat_mat( 100:495, i ), 99, 4);
beta  = reshape(feat_mat( 595:end, i ), 99, 4);
% alpha = reshape(feat_mat( 1:99, i ), 99, 1);
% beta  = reshape(feat_mat( 496:594, i ), 99, 1);
...
% pm00006 18Feb11: See my comment at the bottom of 'display_face' for guides on
